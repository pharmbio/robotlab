...
programs[f'lid_h19'] = resolve('scripts/dan_delid.script', [
    section('put', [
        gripper('Gripper Move30% (1)'),
        movejoint('delid_neu'),
        movel('delid_pick_up'),
...
programs[f'r21'] = resolve('scripts/dan_h21_r21.script', [
    section('put', [
        gripper('Gripper Move30% (1)'),
        movejoint('h21_neu'),
        movel('h21_pick_neu'),
...
programs[f'out21'] = resolve('scripts/dan_to_out18.script', [
    section('put', [
        gripper('Gripper Move30% (1)'),
        movejoint('h21_neu'),
        movel('h21_pick_neu'),
...
programs['incu'] = resolve('scripts/dan_incu_to_delid.script', [
    section('put', [
        section('part1', [
            gripper('Gripper Move30% (1)'),
            movejoint('delid_neu'),
...
programs['wash'] = resolve('scripts/dan_wash_putget.script', [
    section('put', [
        gripper('Gripper Move35% (1)'),
        movejoint('neu_deli'),
        movel('abov_dropoff'),
...
programs['disp'] = resolve('scripts/dan_disp_putget.script', [
    section('put', [
        gripper('Gripper Move35% (1)'),
        movejoint('neu_deli'),
        movel('dropoff_above'),
